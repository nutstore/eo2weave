...
export const settings = {
    ...
    webMCPManageInExtension: "サイト/ツールグループの承認はブラウザー拡張のポップアップで管理されます。拡張アイコンをクリックして調整してください。ここでは現在の状態のみが表示されます。",
    webMCPAuthAllowed: "許可",
    webMCPAuthBlocked: "ブロック",
    ...
    gatewayRateLimits: {
      ...
      monthly: "月間パッケージ",
      topup: "クレジットパック {count}",
      resetUnknown: "リセット時刻不明",
      resetSoon: "まもなくリセット",
      resetInHours: "{count}時間後にリセット",
      resetInDays: "{count}日後にリセット",
      expireUnknown: "有効期限不明",
      expireSoon: "まもなく期限切れ",
      expireInHours: "{count}時間後に期限切れ",
      expireInDays: "{count}日後に期限切れ",
      refresh: "更新",
      refreshing: "更新中...",
      queryFailed: "取得に失敗",
    },
